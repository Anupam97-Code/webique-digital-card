...
const ContactSection = ({ profile, darkMode, contactBg }) => {
  ...
  const ActionItem = ({ icon, title, subtitle, href }) => {
    ...
    return (
      <Wrapper
        {...wrapperProps}
        className="w-100 d-flex align-items-center justify-content-between text-decoration-none p-2 border for-style"
        style={{
