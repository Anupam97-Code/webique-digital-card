    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="btn position-fixed border rounded-circle shadow d-flex align-items-center justify-content-center"
                style={{
                                    ...
                                    return (
                                        <div key={i} style={{ width: cardWidth }}>
                                            <div
                                                ...
                                                style={{ background: darkMode ? profile.colors.trinery_light : profile.colors.white }}
                                            >
